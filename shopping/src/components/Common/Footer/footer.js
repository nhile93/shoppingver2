                ...
                <div className="right-side col-lg-8 pl-lg-5">
                  ...
                  <div className="sub-columns">
                    ...
                    <div className="sub-two-right">
                      ...
                      <h6>We accept:</h6>
                      <ul>
                        <li><a className="pay-method" href="#"><span className="fa fa-cc-visa" aria-hidden="true"></span></a>
                        </li>
                        <li><a className="pay-method" href="#"><span className="fa fa-cc-mastercard" aria-hidden="true"></span></a>
                        </li>
                        <li><a className="pay-method" href="#"><span className="fa fa-cc-paypal" aria-hidden="true"></span></a>
                        </li>
                        <li><a className="pay-method" href="#"><span className="fa fa-cc-amex" aria-hidden="true"></span></a>
                        </li>
                      </ul>
                    </div>
                  </div>
